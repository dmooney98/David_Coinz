...
//==================================================================================================
// This activity is used to show the user the first page of the Help section.  The only action
// required in this activity is to make sure that the background is set correctly.
// From this activity the user can go to the MainMenu activity, or go to Help2 - the second page of
// the Help section
public class Help extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image = (ImageView) findViewById(R.id.H_background);
    ...
    //==============================================================================================
    // Take the user to the Help2 activity to view the next page of the Help section, nothing needs
    // to be passed
